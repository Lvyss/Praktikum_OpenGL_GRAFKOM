...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "UTS - Texture 2D", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader ourShader("src/uts/uts.vs", "src/uts/uts.fs");
    ...
    if (data)
    {
        ...
        std::cout << "profil.jpg loaded: " << width << "x" << height << ", channels: " << nrChannels << std::endl;
    }
    else
    {

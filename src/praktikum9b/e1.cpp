...
int main()
{
    ...
    Shader lightingShader("src/praktikum9b/6.multiple_lights.vs", "src/praktikum9b/6.multiple_lights.fs");
    Shader lightCubeShader("src/praktikum9b/6.light_cube.vs", "src/praktikum9b/6.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // DESERT THEME: background color (warm sand color)
        ...
        // ========== DESERT THEME LIGHTING SETTINGS ==========
        
        // Directional light (warm desert sun)
        lightingShader.setVec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
        lightingShader.setVec3("dirLight.ambient", 0.3f, 0.24f, 0.14f);    // warm ambient
        lightingShader.setVec3("dirLight.diffuse", 0.7f, 0.42f, 0.26f);     // warm orange diffuse
        lightingShader.setVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);       // white specular
        
        // Point light 0 (orange)
        ...
        // SpotLight (flashlight) - warm yellow for desert theme
        lightingShader.setVec3("spotLight.position", camera.Position);
        lightingShader.setVec3("spotLight.direction", camera.Front);
        lightingShader.setVec3("spotLight.ambient", 0.0f, 0.0f, 0.0f);
        lightingShader.setVec3("spotLight.diffuse", 0.8f, 0.8f, 0.0f);    // yellow flashlight
        lightingShader.setVec3("spotLight.specular", 0.8f, 0.8f, 0.0f);   // yellow specular
        ...
        // also draw the lamp objects (light bulbs)
        lightCubeShader.use();
